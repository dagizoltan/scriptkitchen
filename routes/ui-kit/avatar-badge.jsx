...
export default function AvatarBadgeDemo() {
  return (
    <section>
      ...
      <p>
        Displays a user avatar image with a small status indicator (online,
        offline, busy, etc.). Useful for user lists, chat apps, or anywhere you
        want to show user presence or status.
      </p>
